...
g++ -std=c++17 -Wall -Wextra -O2 -Isrc/core -Isrc/constraints -o bin/demo_soft_constraints.exe demo_soft_constraints.cpp build/core/data_structures.o build/core/instance_parser.o build/core/instance.o build/constraints/hard_constraints.o build/constraints/soft_constraints.o
